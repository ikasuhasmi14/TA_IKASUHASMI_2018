...
<html lang="en">
    <head>        
        ...
        <!-- EOF CSS INCLUDE -->     
<script>
function getRadioCheckedValue(subject_mp)
{
   var oRadio = document.forms[0].elements[subject_mp];
 
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form action="<?php echo site_url('c_beranda/inserteng')?>" method="post" class="form-horizontal">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Form Tambah Siswa English</strong></h3>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9 col-xs-12">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                        <input type="text" name="subject_mp" class="form-control" readonly value=<?php echo "English"?>>
                                                    </div>            
