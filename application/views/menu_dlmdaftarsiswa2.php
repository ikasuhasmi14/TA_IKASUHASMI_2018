                ...
                <div class="content-frame">   
                    ...
                    <div class="content-frame-body content-frame-body-left">
                        ...
                        <div class="gallery" id="links">
                          ...
                          <a class="gallery-item" href="<?php echo site_url('c_beranda/form_inputnilai2/').$nama."/".$id_siswaenglish."/".$level;?>" title="Input Nilai" >
                                <div class="image">
                                    <img src="<?php echo base_url(); ?>assets/assets/images/gallery/nilai.png" alt="Nature Image 6"/>                                                               
                                </div>
                                <div class="meta">
                            ...
                            <a class="gallery-item" href="<?php echo site_url('c_beranda/form_absensis2/').$nama."/".$level."/".$tingkatan."/".$id_siswaenglish."/".$subject_mp;?>" title="Girls Image 3" data-gallery>
                                <div class="image">
                            ...
                            <a class="gallery-item" href="<?php echo site_url('c_beranda/form_spp2/').$id_siswaenglish."/".$level; ?>" title="Nature Image 7" data-gallery>
                                <div class="image">
