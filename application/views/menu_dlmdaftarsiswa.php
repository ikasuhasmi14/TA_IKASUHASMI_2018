                ...
                <div class="content-frame">   
                    ...
                    <div class="content-frame-body content-frame-body-left">
                        ...
                        <div class="gallery" id="links">
                            ...
                            <a class="gallery-item" href="<?php echo site_url('c_beranda/form_inputnilai/').$nama."/".$id_siswa."/".$level;?>" title="Input Nilai" >
                                <div class="image">
                            ...
                            <a class="gallery-item" href="<?php echo site_url('c_beranda/form_absensis/').$nama."/".$level."/".$tingkatan."/".$id_siswa."/".$subject_mp;?>" title="Girls Image 3" data-gallery>
                                <div class="image">
