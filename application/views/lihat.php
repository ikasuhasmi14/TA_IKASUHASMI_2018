...
<!-- PAGE TITLE -->
                <div class="page-title">                    
                    <h2>Tabel Absen Asisten Pembimbing Kumon</h2>
                </div>
                <!-- END PAGE TITLE -->                
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                               ...
                               <?php 
                                    $sql =  "select * from data_pemb join absen on data_pemb.id_asisten = absen.id_asisten where absen.id_asisten=$id_asisten";
