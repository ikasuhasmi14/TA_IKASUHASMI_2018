...
<!-- PAGE TITLE -->
                <div class="page-title">                    
                    <h2><span class="fa fa-users"></span> Daftar Nilai Kumon English</h2>
                </div>
                <!-- END PAGE TITLE -->    
                ...
                <div class="page-content-wrap">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-4">
                                <a href="<?php echo site_url('c_beranda/menu_nilai2/').$nama."/".$id_siswaenglish;?>"  class="btn btn-success btn-block">Lihat Tabel nilai <?php echo $nama ?></a>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                           ...
                           <form action="<?php echo site_url('c_beranda/insertnilai2')?>" id="form1" name="form1" class="form-horizontal" method="post">
                            <div class="panel panel-default">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name="id_siswaenglish" readonly value="<?php echo $id_siswaenglish ?>"/>
                                            </div>                                            
                                      ...
                                      <?php 
                                    $sql =  "select * from data_siswaenglish where id_siswaenglish=$id_siswaenglish";
                        ...
                        foreach($query->result() as $a) { 
                                   ...
                                   <div class="form-group">
                                        ...
                                        <input type="text" id="dari" name="dari" readonly value="<?php echo $dari ?>"/> Soal
