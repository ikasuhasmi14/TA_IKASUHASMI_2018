                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                               ...
                               <?php 
                                    ...
                                    $sql =  "SELECT b.nama,a.fcm_token FROM fcm_info a,data_siswa b where b.id_siswa=a.id_siswa and a.id_siswa =".$id_siswas;
                                    ...
                                    ?>  
                                               ...
                                               <td><?= $r->nama?></td>
                                                    <td><strong><?= $r->fcm_token?></strong></td>
                                                     <td>
                                                        <a href="http://localhost/ika/login/index.php/c_beranda/kirimPerid/<?= $r->fcm_token?>/<?= $r->nama?>/<?php echo $id_absen; ?>/<?php echo $jam_keluar; ?>" class="btn btn-primary pull-right" name="kirimke" value="kirimke" type="submit">Kirim</button>
