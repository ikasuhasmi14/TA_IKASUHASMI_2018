                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                           ...
                           <?php if($dataEdit){
                                ...
                                $id_siswaenglish = $dataEdit->id_siswaenglish;
                            ...
                            <form action="<?php echo site_url('c_beranda/updateabsen/'.$id_absensis."/".$nama."/".$jam_keluar)?>" class="form-horizontal" method="post">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Form Edit Absensi Siswa</h3>
                                ...
                                <div class="panel-body">    
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" class="form-control" name="level" readonly value="<?php echo $level?>"/>
                                            </div>                                            
                                            <span class="help-block">This is sample of text field</span>
                                        </div>
                                    </div>
                                ...
                                <div class="panel-footer">
                                    ...
                                    <a href="<?php echo site_url("c_beranda/daftarKontak2/".$id_absensis."/".$id_siswaenglish)?>" name="kirim" class="btn btn-primary pull-right" >Kirim ke</a>
                                </div>
                            </div>
                            </form>
