...
<!-- PAGE TITLE -->
                ...
                <div class="page-title">                    
                    <h2>Tabel Absen Asisten Pembimbing English Kumon</h2>
                </div>
                <!-- END PAGE TITLE -->                
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    ...
                                    <h3 class="panel-title">Tabel Absen Asisten Pembimbing<strong> <?php echo $nama?></strong></h3>
                                ...
                                <div class="panel-body">
                                 ...
                                 <?php 
                                    ...
                                    $sql =  "select * from data_pemb2 join absen on data_pemb2.id_assist = absen.id_assist where absen.id_assist=$id_assist";
                        ...
                        foreach($query->result() as $r) { 
                                    ?>  
                                                 <tr> 
                                              <td><?= $r->nama;?></td>
                                                    <td><strong><?= $r->bidang;?></strong></td>
                                                    <td><span class="label label-success"><?= $r->tanggal_masuk;?></span></td>
                                                    <td><?= $r->jam_masuk;?></td>
                                                    <td><?= $r->jam_keluar;?></td>

                                                     <td>
                                                        <a href="<?php echo site_url('c_beranda/form_editabsen2/'.$r->id_absen);?>" class="btn btn-default btn-rounded btn-sm" ><span class="fa fa-pencil"></span></a>
