...
<!-- PAGE TITLE -->
                <div class="page-title">                    
                    <h2><span class="fa fa-users"></span> Daftar Absensi Siswa Coba Gratis Kumon Matematika</h2>
                </div>
                <!-- END PAGE TITLE -->    
                ...
                <div class="page-content-wrap">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-4">
                                <a href="<?php echo site_url('c_beranda/coba_lihat/').$nama."/".$id_coba;?>"  class="btn btn-success btn-block">Lihat Tabel Absen <?php echo $nama ?></a>
                                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <form action="<?php echo site_url('c_beranda/insertabsencoba')?>" class="form-horizontal" method="post">
                            <div class="panel panel-default">
