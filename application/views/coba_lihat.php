...
<!-- PAGE TITLE -->
                <div class="page-title">                    
                    <h2>Tabel Absen Siswa Coba Gratis Kumon</h2>
                </div>
                <!-- END PAGE TITLE -->                
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Tabel Absen <strong> <?php echo $nama?></strong></h3>
                               ...
                               <?php 
                                    $sql =  "select * from coba join absen_coba on coba.id_coba = absen_coba.id_coba where absen_coba.id_coba=$id_coba";
                        ...
                        foreach($query->result() as $r) { 
                                    ?>    
                                                 <tr> 
                                               <td><?= $r->nama?></td>
                                               <td><strong><?php echo $r->subject_mp?></strong></td>
                                                    <td><strong><?php echo $r->kelas?></strong></td>
                                                    <td><span class="label label-success"><?php echo $r->tanggal_masuk?></span></td>
