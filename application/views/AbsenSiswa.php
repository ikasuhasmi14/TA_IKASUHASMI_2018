                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Tabel Absen <?php echo $nama?></h3>
                               ...
                               <?php 
                                    $sql =  "select * from data_siswa join absensis on data_siswa.id_siswa = absensis.id_siswa where absensis.id_siswa=$id_siswa";
