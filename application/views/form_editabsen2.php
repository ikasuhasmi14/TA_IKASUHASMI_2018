                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                           ...
                           <?php if($dataEditpemb){
                                ...
                                $id_assist = $dataEditpemb->id_assist;
                                $nama = $dataEditpemb->nama;
                                 $tanggal_masuk = $dataEditpemb->tanggal_masuk;
                                $jam_masuk = $dataEditpemb->jam_masuk;
                                $jam_keluar = $dataEditpemb->jam_keluar;
                             }
                            ...
                            <form action="<?php echo site_url('c_beranda/updateabsenEng/'.$id_absen."/".$nama)?>" class="form-horizontal" method="post">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Form Edit Absensi Asisten</h3>
