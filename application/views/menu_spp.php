...
<!-- PAGE TITLE -->
                ...
                <div class="page-title">                    
                    <h2>Tabel SPP Siswa Kumon Matematika</h2>
                </div>
                <!-- END PAGE TITLE -->                
                        ...
                        foreach($query->result() as $aa) { 
                                              ...
                                              <td><strong><?=$aa->nama;?></strong></td>
                                                  ...
                                                  <td>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo site_url('c_beranda/form_spp/'.$aa->id_siswa);?>" class="btn btn-default btn-rounded btn-sm">
                                                        Bayar
                                                        </a>

                                                        <a href="<?php echo site_url('c_beranda/daftarKontakspp/'.$aa->id_siswa);?>" class="btn btn-default btn-rounded btn-sm">
                                                        Send as Message
                                                        </a>
                                                    </td>
                                            </tr>
  ...
  <?php 
                                            ...
                                            $sql = "select MAX(id_spp) as a from spp group by spp.id_siswa";
                        ...
                        foreach($query->result() as $a) { 
                            $max = $a->a;
                            $sql2 = "select spp.id_siswa, data_siswa.nama, data_siswa.kelas, data_siswa.subject_mp, spp.tunai,spp.status_pembayaran,spp.bulan,data_siswa.tanggal_masuk from data_siswa left outer join spp 
                            on data_siswa.id_siswa = spp.id_siswa where id_spp = $max and (status_pembayaran='Lunas' or bulan >= $bulan_sekarang)  group by spp.id_siswa";
                             $query = $this->db->query($sql2);
