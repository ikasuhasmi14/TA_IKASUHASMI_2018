                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form action="<?php echo site_url('c_beranda/insertcoba2')?>" method="post" class="form-horizontal">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Form Tambah Siswa English Coba Gratis</strong></h3>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9 col-xs-12">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="" name="subject_mp" class="form-control" readonly value=<?php echo "English"?>>
                                                    </div>            
