    ...
    <body>
        ...
        <?php $this->load->view('frame/header')?>
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form action="<?php echo site_url('c_beranda/cetak_data_siswa_eng')?>" method="post" class="form-horizontal" name="form" >
                            <!-- START DATATABLE EXPORT -->
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Pilih kategori data yang akan dicetak</h3>
                                        ...
                                        <div class="col-md-6">
                                                ...
                                                <div class="col-md-9">                                                                                            
                                                    <select class="form-control select" name="kategori">
                                                        ...
                                                        <option value="Level Awal">Level Awal</option>
                                                        <!-- <option value="Bulan Masuk">Bulan Masuk</option> -->
                                                        <option value="Sertifikat">Sertifikat</option>
                                                    </select>
                                                    <span class="help-block">Pilih kategori data</span>
                                                </div>
                                            </div>
