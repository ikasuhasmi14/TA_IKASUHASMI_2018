...
<html lang="en">
    <head>        
        <!-- META SECTION -->
        <title>Absensi Siswa Coba Gratis</title>            
...
<!-- PAGE TITLE -->
                <div class="page-title">                    
                    <h2><span class="fa fa-users"></span> Daftar Absensi Siswa Coba Gratis Kumon English</h2>
                </div>
                <!-- END PAGE TITLE -->    
                ...
                <div class="page-content-wrap">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-4">
                                <a href="<?php echo site_url('c_beranda/coba_lihat/').$nama."/".$id_coba2;?>"  class="btn btn-success btn-block">Lihat Tabel Absen <?php echo $nama ?></a>
                                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <form action="<?php echo site_url('c_beranda/insertabsencoba2')?>" class="form-horizontal" method="post">
                            <div class="panel panel-default">
