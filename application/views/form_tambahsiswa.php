...
function validasi_input(form){
  if (form.nama.value == ""){
   ...
   var mincar = 12;
  if (form.no_hp.value.length < mincar){
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form action="<?php echo site_url('c_beranda/insert')?>" method="post" class="form-horizontal" name="form" onsubmit="return validasi_input(this)">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Form Tambah Siswa Matematika</strong></h3>
                                ...
                                <div class="panel-body">                                                                        
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-control select" name="level_target">
                                                        <option   value='7A'>7A</option>
                                                        <option   value='6A'>6A</option>
                                                        <option   value='5A'>5A</option>
                                                        <option  value='4A'>4A</option>
                                                    ...
                                                    <span class="help-block">Isilah Level Target Kumon</span>
                                                </div>
                                            </div>
                                              <div class="form-group">
                                                <label class="col-md-3 control-label">Status Sertifikat</label>
                                                <div class="col-md-9">                                                                                            
                                                    <select class="form-control select" name="status_sertifikat">
