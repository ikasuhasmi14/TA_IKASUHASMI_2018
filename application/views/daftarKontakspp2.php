                                    ...
                                    ?>  
                                               ...
                                               <td><?= $r->nama?></td>
                                                    <td><strong><?= $r->fcm_token?></strong></td>
                                                     <td>
                                                        <a href="http://localhost/ika/login/index.php/c_beranda/kirimPerideng/<?= $r->fcm_token?>/<?= $r->nama?>/<?php echo $id_spp2; ?>/<?php echo $bulan;?>" class="btn btn-primary pull-right" name="kirimke" value="kirimke" type="submit">Kirim</button>
