...
<html lang="en">
    <head>        
        <!-- META SECTION -->
        <title>Menu Daftar Siswa Kumon English</title>            
    ...
    <body>
        ...
        <?php $this->load->view('frame/header')?>
                ...
                <div class="page-title">                    
                    <h2><span class="fa fa-users"></span> Daftar Siswa Kumon English</h2>
                </div>
                <!-- END PAGE TITLE -->                
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="col-md-4">
								<a href="<?php echo site_url('c_beranda/form_tambahsiswa2')?>"  class="btn btn-success btn-block"><span class="fa fa-plus"></span> Tambah Siswa</a>
                                    </div>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    ...
                                    <div class="btn-group pull-right">
                                      <!--   <button> <a href="<?php echo site_url('c_beranda/siswa_report_eng')?>" ><i class="fa fa-file-pdf-o"></i> Cetak PDF </a></button> -->
                                ...
                                <?php 
                                    ...
                                    ?>      
                                               ...
                                               <td><strong><?php echo $r ['nama'];?></strong></td>
                                                    ...
                                                    <td><?php echo $r['status_sertifikat'];?></span></td>
                                                    <td><?php echo $r['level_awal'];?></td>
                                                    <td><?php echo $r['tanggal_masuk'];?></td>
                                                    <td><?php echo $r['orang_tua'];?></td>
                                                    <td><a href="<?php echo site_url('c_beranda/menu_dlmdaftarsiswa2/').$r['nama']."/".$r['id_siswaenglish'];?>" class=""><span class="fa fa-info-circle"></span>&nbsp;Detail</a> &nbsp; &nbsp; <a href="<?php echo site_url('c_beranda/form_editsiswa2/'.$r['id_siswaenglish'])?>" class=""><span class="fa fa-pencil-square-o"></span>Edit</a>
                                                         </td>
