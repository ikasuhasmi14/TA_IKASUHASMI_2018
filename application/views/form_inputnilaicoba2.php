...
<!-- PAGE TITLE -->
                <div class="page-title">                    
                    <h2><span class="fa fa-users"></span> Daftar Nilai Coba Gratis Kumon English</h2>
                </div>
                <!-- END PAGE TITLE -->    
                ...
                <div class="page-content-wrap">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-4">
                                <a href="<?php echo site_url('c_beranda/menu_nilai/').$nama."/".$id_coba2;?>"  class="btn btn-success btn-block">Lihat Tabel nilai <?php echo $nama ?></a>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                           ...
                           <form action="<?php echo site_url('c_beranda/insertnilaicoba2')?>" id="form1" name="form1" class="form-horizontal" method="post">
                            <div class="panel panel-default">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name="id_coba2" readonly value="<?php echo $id_coba2 ?>"/>
                                            </div>                                            
                                      ...
                                      <?php 
                                    $sql =  "select * from coba2 where id_coba2=$id_coba2";
                        ...
                        foreach($query->result() as $a) { 
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" class="form-control" name="tipe_test" readonly value="<?php echo "DT"?>"/>
                                            </div>                                            
                                            <span class="help-block">This is sample of text field</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">                                        
                                            ...
                                            <select class="form-control select" name="levell" value="<?php echo $levell ?>">
                                   ...
                                   <div class="form-group">
                                        ...
                                        <input type="text"  name="dari" /> Soal
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Dari</label> 
                                           ...
                                           <input type="text" name="darimenit"/> Menit
