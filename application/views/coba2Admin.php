...
<html lang="en">
    <head>        
        <!-- META SECTION -->
        <title>Daftar Siswa Kumon Coba Gratis English</title>            
    ...
    <body>
        ...
        <?php $this->load->view('frame/header')?>
                ...
                <div class="page-title">                    
                    <h2><span class="fa fa-users"></span> Daftar Siswa Kumon English Coba Gratis</h2>
                </div>
                <!-- END PAGE TITLE -->                
                ...
                <div class="page-content-wrap">
                   ...
                   <!--  <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="col-md-4">
								<a href="<?php echo site_url('c_beranda/form_tambahcoba2')?>"  class="btn btn-success btn-block"><span class="fa fa-plus"></span> Tambah Siswa</a>
                                    </div>
                                ...
                                <?php 
                                    ...
                                    ?>      
                                               ...
                                               <td><strong><?php echo $r ['nama'];?></strong></td>
                                                   ...
                                                   <!--  <td><a href="<?php echo site_url('c_beranda/menu_dlmcoba2/').$r['nama']."/".$r['id_coba2'];?>" class=""><span class="fa fa-info-circle"></span>&nbsp;Detail</a> &nbsp; &nbsp; <a href="<?php echo site_url('c_beranda/form_editsiswacoba2/'.$r['id_coba2'])?>" class=""><span class="fa fa-pencil-square-o"></span>Edit</a>
                                                         </td>
 -->
