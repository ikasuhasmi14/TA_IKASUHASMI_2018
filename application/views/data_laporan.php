    ...
    <body>
        ...
        <?php $this->load->view('frame/header')?>
                ...
                <div class="page-title">                    
                    <h2>Tabel Nilai Siswa Kumon Matematika</h2>
                </div>
                <!-- END PAGE TITLE -->                
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Eksport Laporan Kemajuan Siswa Matematika</h3>
                                    <div class="btn-group pull-right">
                                        <button> <a href="<?php echo site_url('c_beranda/report')?>" ><i class="fa fa-file-pdf-o"></i> Cetak PDF </a></button>
                                ...
                                <?php 
                                    $sql =  "select * from data_siswa join data_nilai on data_siswa.id_siswa = data_nilai.id_siswa";
                        ...
                        foreach($query->result() as $r) { 
                                ...
                                <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Eksport Data Tabel Coba Gratis</h3>
                                    <div class="btn-group pull-right">
