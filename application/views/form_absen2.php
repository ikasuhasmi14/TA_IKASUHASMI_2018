...
<!-- PAGE TITLE -->
                <div class="page-title">                    
                    <h2><span class="fa fa-users"></span> Daftar Absensi Asisten Kumon English</h2>
                </div>
                <!-- END PAGE TITLE -->    
                ...
                <div class="page-content-wrap">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-4">
                                <a href="<?php echo site_url('c_beranda/lihat2/').$nama."/".$id_assist;?>"  class="btn btn-success btn-block">Lihat Tabel Absen <?php echo $nama ?></a>
                                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <form action="<?php echo site_url('c_beranda/insertabsenpemb2')?>" class="form-horizontal" method="post">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name="id_assist" readonly value="<?php echo $id_assist?>" />
                                            </div>                                            
                                    ...
                                    <?php 
                                    $sql =  "select * from data_pemb2 where id_assist=$id_assist";
