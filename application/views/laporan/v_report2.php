...
foreach ($siswaeng as $key => $row) {
$table .= '<tr>
		<td style="border:1px solid #000; width:55">' .$row->id_siswaenglish. '</td>
		...
		<td style="border:1px solid #000; width:55">'.$row->level_awal.'</td>
...
ob_clean();
$pdf->Output('ReportB English.pdf', 'I');
