...
<html lang="en">
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <?php if($dataEditCoba2){
								$id = $dataEditCoba2->id_coba2;
								$nama = $dataEditCoba2->nama;
								$kelas = $dataEditCoba2->kelas;
								$level = $dataEditCoba2->level;
								$orang_tua = $dataEditCoba2->orang_tua;
								$no_hp = $dataEditCoba2->no_hp;
                                $tanggal_lahir = $dataEditCoba2->tanggal_lahir;
                               }
							else{
								$nama = "";
								$kelas = "";
 ...
 <form action="<?php echo site_url('c_beranda/updatecoba2/'.$id)?>" method="post" class="form-horizontal">
