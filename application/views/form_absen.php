...
<!-- PAGE TITLE -->
                <div class="page-title">                    
                    <h2><span class="fa fa-users"></span> Daftar Absensi Asisten Kumon Matematika</h2>
                </div>
                <!-- END PAGE TITLE -->    
                ...
                <div class="page-content-wrap">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-4">
                                <a href="<?php echo site_url('c_beranda/lihat/').$nama."/".$id_asisten;?>"  class="btn btn-success btn-block">Lihat Tabel Absen <?php echo $nama ?></a>
                                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <form action="<?php echo site_url('c_beranda/insertabsenpemb')?>" class="form-horizontal" method="post">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Id Asisten </label>
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" class="form-control" name="id_asisten" readonly value="<?php echo $id_asisten?>" />
                                            </div>                                            
                                    ...
                                    <?php 
                                    $sql =  "select * from data_pemb where id_asisten=$id_asisten";
                        ...
                        foreach($query->result() as $a) { 
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" class="form-control" name="bidang" readonly value="<?=$a->bidang?>"/>
                                            </div>                                            
                                            <span class="help-block" >This is sample of text field</span>
                                        </div>
                                    </div>     
