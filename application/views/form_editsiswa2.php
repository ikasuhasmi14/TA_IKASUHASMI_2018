...
<html lang="en">
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <?php if($dataEditeng){
								$id = $dataEditeng->id_siswaenglish;
								$nama = $dataEditeng->nama;
								$kelas = $dataEditeng->kelas;
								$level = $dataEditeng->level;
								$orang_tua = $dataEditeng->orang_tua;
								$no_hp = $dataEditeng->no_hp;
                                $tanggal_lahir = $dataEditeng->tanggal_lahir;
                                $status_sertifikat = $dataEditeng->status_sertifikat;}
							else{
								$nama = "";
								$kelas = "";
								$level = "";
 ...
 <form action="<?php echo site_url('c_beranda/updateeng/'.$id)?>" method="post" class="form-horizontal">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Form Edit Siswa English</strong></h3>
                                ...
                                <div class="panel-footer">
                                    ...
                                    <button type="submit" name="editeng"  class="btn btn-primary pull-right">Edit</button>
                                </div>
                            </div>
                            </form>
