                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    ...
                                    <h3 class="panel-title">Tabel Absen Siswa Kumon</h3>
                                ...
                                <div class="panel-body">
                                 ...
                                 <?php 
                                    ...
                                    $sql =  "select * from absensis where subject_mp ='Matematika';";
                        ...
                        foreach($query->result() as $r) { 
                                    ?>  
                                              ...
                                              <td><?= $r->nama;?></td>
                                                    ...
                                                    <td><?= $r->jam_keluar;?></td>
                                                     ...
                                                     <td>
                                                        <a href="<?php echo site_url('c_beranda/form_editabsensis/'.$r->id_absensis);?>" class="btn btn-default btn-rounded btn-sm" ><span class="fa fa-pencil"></span></a>
                                ...
                                <div class="panel-body">
                                 ...
                                 <?php 
                                    ...
                                    $sql =  "select * from absen_coba where subject_mp ='Matematika';";
                                     $query = $this->db->query($sql);
                                    ...
                                    ?>  
                                                 <tr> 
                                                    ...
                                                    <td><?= $r->jam_keluar;?></td>
                                                     ...
                                                     <td>
                                                        <a href="<?php echo site_url('c_beranda/form_editabsencoba/'.$r->id_absencoba);?>" class="btn btn-default btn-rounded btn-sm" ><span class="fa fa-pencil"></span></a>
