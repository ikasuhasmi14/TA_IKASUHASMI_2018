    ...
    <body>
        ...
        <?php $this->load->view('frame/header')?>
                ...
                <div class="page-title">                    
                    <h2>Cetak Data Siswa berdasarkan Bulan Masuk</h2>
                </div>
                <!-- END PAGE TITLE -->                
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form action="<?php echo site_url('c_beranda/cetak_data_siswa_bulan')?>" method="post" class="form-horizontal" name="form" >
                            <!-- START DATATABLE EXPORT -->
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Pilih Bulan Masuk data siswa yang akan dicetak</h3>
                                ...
                                <div class="panel-body">                                                                        
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                                ...
                                                <br>
                                                <label class="col-md-3 control-label">Bulan Masuk</label>
                                                <div class="col-md-9">                                                                                            
                                                    <select class="form-control select" name="bulan">
                                                        <?php //for
                                                         foreach($bulan as $key => $row){
                                                        ?>
                                                        <option value="<?php echo $row->kat_bulan;?>"><?php echo $row->kat_bulan;?></option>
                                                        <?php }?>
                                                    </select>
                                                    <span class="help-block">Pilih Bulan Masuk Siswa</span>
                                                </div>
                                            </div>
