    ...
    <body>
        ...
        <?php $this->load->view('frame/header')?>
                ...
                <div class="page-title">                    
                    <h2>Cetak Data Siswa berdasarkan Level Awal</h2>
                </div>
                <!-- END PAGE TITLE -->                
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form action="<?php echo site_url('c_beranda/cetak_data_siswa_level_awal_eng')?>" method="post" class="form-horizontal" name="form" >
                            <!-- START DATATABLE EXPORT -->
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Pilih level awal data siswa yang akan dicetak</h3>
                                ...
                                <div class="panel-body">                                                                        
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                                ...
                                                <div class="col-md-9">                                                                                            
                                                    <select class="form-control select" name="levelawal">
                                                        <?php //for
                                                         foreach($level as $key => $row){
                                                        ?>
                                                        <option value="<?php echo $row->kat_level;?>"><?php echo $row->kat_level;?></option>
                                                        <?php }?>
                                                    </select>
                                                    <span class="help-block">Pilih Level Awal Siswa</span>
                                                </div>
                                            </div>
