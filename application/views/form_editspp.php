                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                             ...
                             <?php if($dataEdit){
								$id_siswa = $dataEdit->id_siswa;
								$nama = $dataEdit->nama;
                                $subject_mp = $dataEdit->subject_mp;
								$level = $dataEdit->level;
								$tingkatan = $dataEdit->tingkatan;
								$bulan_pembayaran = $dataEdit->bulan_pembayaran;
								$tunai = $dataEdit->tunai;
								$status_pembayaran = $dataEdit->status_pembayaran;
                            ...
                            <form action="<?php echo site_url('c_beranda/updatespp/').$id_spp?>" id="form1" name="form1" class="form-horizontal" method="post">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Form Edit SPP</strong></h3>
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" class="form-control"  name="subject_mp" value="<?php echo $subject_mp; ?>"/>
                                            </div>                                            
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                     
                                            ...
                                            <select class="form-control select" id="tingkatan" name="tingkatan" onchange="tampilkan()" value="<?php echo $tingkatan ?>">
                              ...
                              <label class="col-md-3 col-xs-12 control-label">Bulan Pembayaran</label>
                                        <div class="col-md-6 col-xs-12">
                                            <div class="input-group">
                                                ...
                                                <input type="text"  name="bulan_pembayaran" class="form-control" value= "<?php echo $bulan_pembayaran?>">                                            
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" id="tunai" name="tunai" class="form-control" value="<?php echo $tunai?>"/>
                                            </div>                                            
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                                                                            
                                            <select class="form-control select" name="status_pembayaran"  value="<?php echo $status_pembayaran?>">
                                                <option>Lunas</option>
                                ...
                                <div class="panel-footer">
                                    ...
                                    <button class="btn btn-primary pull-right" name="tambah" value="tambah">Edit</button>
                                </div>
                            </div>
                            </form>
