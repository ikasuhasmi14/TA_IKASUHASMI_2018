                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <?php if($dataEdit){
                                ...
                                $level_target = $dataEdit->level_target;
								$Orang_tua = $dataEdit->Orang_tua;
								$no_hp = $dataEdit->no_hp;
                                $tanggal_lahir = $dataEdit->tanggal_lahir;
                                $status_sertifikat = $dataEdit->status_sertifikat;}
							else{
								$nama = "";
								$kelas = "";
								$level = "";
								...
								$no_hp = "";
                                $tanggal_lahir ="";
                                $status_sertifikat = "Sudah terima";}
							?>
	
 <form action="<?php echo site_url('c_beranda/update/'.$id)?>" method="post" class="form-horizontal">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">                                                                                            
                                                    <select class="form-control select" name="status_sertifikat" value="<?php echo $status_sertifikat ?>">
                                                        <option>Belum terima</option>
                                                        <option>Sudah terima</option>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">                                        
                                                <label class="col-md-3 control-label">Level Target</label>
                                                <div class="col-md-9">
                                                    <!-- <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                        <input type="text" name="level" value="<?php echo $level ?>"class="form-control" >                                            
                                            ...
                                            <select class="form-control select" name="level_target" value="<?php echo $level_target ?>">
                                                        <option  <?php if($level_target == '7A'){echo "selected";}?> value='7A'>7A</option>
                                                        <option  <?php if($level_target == '6A'){echo "selected";}?> value='6A'>6A</option>
                                                        <option  <?php if($level_target == '5A'){echo "selected";}?> value='5A'>5A</option>
                                                        <option <?php if($level_target == '4A'){echo "selected";}?> value='4A'>4A</option>
                                                        <option <?php if($level_target == '3A'){echo "selected";}?> value='3A'>3A</option>
                                                        <option <?php if($level_target == '2A'){echo "selected";}?> value='2A'>2A</option>
                                                        <option <?php if($level_target == 'A'){echo "selected";}?> value='A'>A</option>
                                                        <option <?php if($level_target == 'B'){echo "selected";}?> value='B'>B</option>
                                                        <option <?php if($level_target == 'C'){echo "selected";}?> value='C'>C</option>
                                                        <option <?php if($level_target == 'D'){echo "selected";}?> value='D'>D</option>
                                                        <option <?php if($level_target == 'E'){echo "selected";}?> value='E'>E</option>
                                                        <option <?php if($level_target == 'F'){echo "selected";}?> value='F'>F</option>
                                                        <option <?php if($level_target == 'G'){echo "selected";}?> value='G'>G</option>
                                                        <option <?php if($level_target == 'H'){echo "selected";}?> value='H'>H</option>
                                                        <option <?php if($level_target == 'I'){echo "selected";}?> value='I'>I</option>
                                                        <option <?php if($level_target == 'J'){echo "selected";}?> value='J'>J</option>
                                                        <option <?php if($level_target == 'K'){echo "selected";}?> value='K'>K</option>
                                                        <option <?php if($level_target == 'L'){echo "selected";}?> value='L'>L</option>
                                                        <option <?php if($level_target == 'M'){echo "selected";}?> value='M'>M</option>
                                                        <option <?php if($level_target == 'N'){echo "selected";}?> value='N'>N</option>
                                                        <option <?php if($level_target == 'O'){echo "selected";}?> value='O'>O</option>
                                                        <option <?php if($level_target == 'X'){echo "selected";}?> value='X'>X</option>
