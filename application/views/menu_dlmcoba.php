                ...
                <div class="content-frame">   
                    ...
                    <div class="content-frame-body content-frame-body-left">
                        ...
                        <div class="gallery" id="links">
                            ...
                            <a class="gallery-item" href="<?php echo site_url('c_beranda/form_inputnilaicoba/').$nama."/".$id_coba;?>" title="Input Nilai" >
                                <div class="image">
                            ...
                            <a class="gallery-item" href="<?php echo site_url('c_beranda/form_absencoba/').$nama."/".$id_coba."/".$subject_mp;?>" title="Girls Image 3" data-gallery>
                                <div class="image">
