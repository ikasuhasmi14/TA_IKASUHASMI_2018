                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                         <div class="col-md-12">
                            ...
                            <div class="col-md-4">
                                <a href="<?php echo site_url('c_beranda/AbsenSiswa2/').$nama."/".$id_siswaenglish;?>"  class="btn btn-success btn-block">Lihat Tabel Absen <?php echo $nama ?></a>
                                    </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <form action="<?php echo site_url('c_beranda/insertabsen2')?>" class="form-horizontal" method="post">
                            <div class="panel panel-default">
                              ...
                              <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Id Siswa English</label>
                        ...
                        foreach($query->result() as $a) { 
                                ...
                                <div class="panel-footer">
                                    ...
                                    <button class="btn btn-primary pull-right" name="tambah" value="tambah" type="submit">Absen</button>
                                </div>
                            </div>
                            </form>
